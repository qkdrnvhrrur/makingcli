...
const mkdirp = (dir) => {
  const dirname = path
    ...
    //console.log(path.relative('.', path.normalize(dir)));
    //console.log(path.relative('.', path.normalize(dir)).split(path.sep));
    //console.log(path.relative('.', path.normalize(dir)).split(path.sep).filter(p=>!!p));
